...
from industy_calculate.siliconflow_qa_record import talk_initialize, execute_conversation, process_lines_to_dict
...
def extract_relevant_data(data):
    ...
    for key, value in data.items():
        ...
        key_tuple = (
            extracted.get("SOURCE_name", ""),       # 来源系统名称
            extracted.get("TARGET_name", ""),       # 目标系统名称
            extracted.get("source_company_keyword", ""),  # 来源企业标识
            extracted.get("target_company_keyword", ""),  # 目标企业标识
            extracted.get("keyword", "")   # 目标企业标识
        )
